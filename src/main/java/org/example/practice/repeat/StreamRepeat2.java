...
public class StreamRepeat2 {
    public static void main(String[] args) {
        ...
        Optional<String> max = names.max(String::compareTo);
        ...
        List<Integer> unique = list5.stream().distinct().toList();
        ...
        Optional<Integer> fifthSmallest = list6.stream().distinct().sorted().skip(4).findFirst();
        System.out.println(fifthSmallest);
        ...
        Optional<String> max1 = strings.stream().max(String::compareTo);
        ...
        List<String> list = list7.stream().map(n -> n + "").filter(n -> n.startsWith("1")).toList();
        ...
        Optional<Integer> reduce = list10.stream().reduce((first1, second) -> second);
        ...
        Optional<Integer> max2 = list12.stream().max(Integer::compareTo);
